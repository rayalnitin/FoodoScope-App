...
export default function Dashboard() {
    ...
    useEffect(() => {
        if (currentUserId) {
            console.log("Setting current user ID in onboarding store:", currentUserId);
            onboardingStore.setCurrentUserId(currentUserId);
        }
    }, [currentUserId]);

    // Explicitly get data for the current user
    const userData = currentUserId ? onboardingStore.getCurrentUserData() : {};
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.welcomeText}>
                    Hello, {user?.name || userData?.name || "Guest"}!
                </Text>
                <Text style={styles.subtitle}>
                    Welcome to your FoodScope Dashboard
                </Text>
            </View>
