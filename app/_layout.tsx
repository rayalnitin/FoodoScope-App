...
export default function RootLayout() {
  ...
  const currentUserId = onboardingStore.currentUserId;
  const currentUserProfile = onboardingStore.userProfiles[currentUserId || ""] || {};
  const userData = currentUserProfile.userData || {};
    ...
    const prepare = async () => {
      try {
        ...
        console.log('Onboarding store hydrated:', {
          isOnboarded: currentUserProfile.isOnboarded || false,
