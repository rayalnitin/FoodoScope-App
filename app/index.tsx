...
export default function Index() {
  ...
  const { currentUserId, userProfiles } = useOnboardingStore();
  const isOnboarded = currentUserId ? userProfiles[currentUserId]?.isOnboarded : false;
  ...
  useEffect(() => {
    ...
    const handleNavigation = async () => {
      ...
      try {
        ...
        console.log("User is authenticated and onboarded, staying on dashboard");
